...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '05c72ff7775e4e35ed85c0d070ee782f6fb99b10e54718d161fb7b8389429224_1' => 'get05c72ff7775e4e35ed85c0d070ee782f6fb99b10e54718d161fb7b83894292241Service',
            '9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d_1' => 'get9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d1Service',
            '9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d_2' => 'get9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d2Service',
            '9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d_3' => 'get9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d3Service',
    ...
    /**
     * Gets the '05c72ff7775e4e35ed85c0d070ee782f6fb99b10e54718d161fb7b8389429224_1' service.
     *
     ...
     */
    protected function get05c72ff7775e4e35ed85c0d070ee782f6fb99b10e54718d161fb7b83894292241Service()
    {
        return $this->services['05c72ff7775e4e35ed85c0d070ee782f6fb99b10e54718d161fb7b8389429224_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }

    /**
     * Gets the '9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d1Service()
    {
        return $this->services['9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the '9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d2Service()
    {
        return $this->services['9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the '9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d3Service()
    {
        return $this->services['9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/pfe2/Symfony/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/www/pfe2/Symfony/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/var/www/pfe2/Symfony/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/var/www/pfe2/Symfony/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'menuisirie2', 'user' => 'root', 'password' => 'hos121085', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_700efc6418ffad255d6f5c99966000b3a18f0fbb441e6643db618710963fe837');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_700efc6418ffad255d6f5c99966000b3a18f0fbb441e6643db618710963fe837');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_700efc6418ffad255d6f5c99966000b3a18f0fbb441e6643db618710963fe837');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('/var/www/pfe2/Symfony/src/Sifast/PfeBundle/Resources/config/doctrine' => 'Sifast\\PfeBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'Sifast\\PfeBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('SifastPfeBundle' => 'Sifast\\PfeBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('/var/www/pfe2/Symfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/pfe2/Symfony/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('05c72ff7775e4e35ed85c0d070ee782f6fb99b10e54718d161fb7b8389429224_1'), $this->get('data_collector.form'));
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => '/var/www/pfe2/Symfony/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer', 'Symfony\\Bundle\\SecurityBundle' => '/var/www/pfe2/Symfony/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer', 'Symfony\\Bundle\\TwigBundle' => '/var/www/pfe2/Symfony/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer', 'Symfony\\Bundle\\MonologBundle' => '/var/www/pfe2/Symfony/vendor/symfony/monolog-bundle/Resources/config/serializer', 'Symfony\\Bundle\\SwiftmailerBundle' => '/var/www/pfe2/Symfony/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/config/serializer', 'Symfony\\Bundle\\AsseticBundle' => '/var/www/pfe2/Symfony/vendor/symfony/assetic-bundle/Symfony/Bundle/AsseticBundle/Resources/config/serializer', 'Doctrine\\Bundle\\DoctrineBundle' => '/var/www/pfe2/Symfony/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/config/serializer', 'Sensio\\Bundle\\FrameworkExtraBundle' => '/var/www/pfe2/Symfony/vendor/sensio/framework-extra-bundle/Sensio/Bundle/FrameworkExtraBundle/Resources/config/serializer', 'Sifast\\PfeBundle' => '/var/www/pfe2/Symfony/src/Sifast/PfeBundle/Resources/config/serializer', 'FOS\\RestBundle' => '/var/www/pfe2/Symfony/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer', 'JMS\\SerializerBundle' => '/var/www/pfe2/Symfony/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer', 'Nelmio\\ApiDocBundle' => '/var/www/pfe2/Symfony/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/config/serializer', 'Acme\\DemoBundle' => '/var/www/pfe2/Symfony/src/Acme/DemoBundle/Resources/config/serializer', 'Symfony\\Bundle\\WebProfilerBundle' => '/var/www/pfe2/Symfony/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer', 'Sensio\\Bundle\\DistributionBundle' => '/var/www/pfe2/Symfony/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer', 'Sensio\\Bundle\\GeneratorBundle' => '/var/www/pfe2/Symfony/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/var/www/pfe2/Symfony/app/logs/dev.log', 100, true);
    }
    ...
    {
        $this->services['nelmio_api_doc.formatter.swagger_formatter'] = $instance = new \Nelmio\ApiDocBundle\Formatter\SwaggerFormatter();
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/var/www/pfe2/Symfony/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/var/www/pfe2/Symfony/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/var/www/pfe2/Symfony/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/var/www/pfe2/Symfony/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/pfe2/Symfony/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/pfe2/Symfony/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d_1'), 1 => $this->get('9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d_2'), 2 => $this->get('9665bfd1428b02dcd1ec900e070ea280fddccbbd6e8cb8ea78ac657388696f0d_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/var/www/pfe2/Symfony/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/var/www/pfe2/Symfony/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/var/www/pfe2/Symfony/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/var/www/pfe2/Symfony/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/pfe2/Symfony/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/var/www/pfe2/Symfony/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/var/www/pfe2/Symfony/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/var/www/pfe2/Symfony/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/var/www/pfe2/Symfony/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/var/www/pfe2/Symfony/src/Sifast/PfeBundle/Resources/views', 'SifastPfe');
        $instance->addPath('/var/www/pfe2/Symfony/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/views', 'NelmioApiDoc');
        $instance->addPath('/var/www/pfe2/Symfony/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/var/www/pfe2/Symfony/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/var/www/pfe2/Symfony/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/var/www/pfe2/Symfony/app/Resources/views');
        $instance->addPath('/var/www/pfe2/Symfony/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/var/www/pfe2/Symfony/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/pfe2/Symfony/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/var/www/pfe2/Symfony/app/cache/dev/assetic/assets');
    }
    ...
    protected function getJmsSerializer_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/var/www/pfe2/Symfony/app/cache/dev/jms_serializer'));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/pfe2/Symfony/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/pfe2/Symfony/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/pfe2/Symfony/app/cache/dev',
            'kernel.logs_dir' => '/var/www/pfe2/Symfony/app/logs',
            'kernel.bundles' => array(
                ...
                'SifastPfeBundle' => 'Sifast\\PfeBundle\\SifastPfeBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'menuisirie2',
            'database_user' => 'root',
            'database_password' => 'hos121085',
            ...
            'httpval' => 'http://localhost/webservice/Symfony',
            ...
            'debug.container.dump' => '/var/www/pfe2/Symfony/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/var/www/pfe2/Symfony/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/var/www/pfe2/Symfony/app/cache/dev/profiler',
            ...
            'router.resource' => '/var/www/pfe2/Symfony/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/pfe2/Symfony/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/var/www/pfe2/Symfony/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/var/www/pfe2/Symfony/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/var/www/pfe2/Symfony/app/../web',
            'assetic.write_to' => '/var/www/pfe2/Symfony/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/pfe2/Symfony/app/cache/dev/doctrine/orm/Proxies',
            ...
            'fos_rest.cache_dir' => '/var/www/pfe2/Symfony/app/cache/dev/fos_rest',
